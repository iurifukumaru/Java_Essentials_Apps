...
public class UserDefinedMethods {
    ...
    public static void main (String[] args) {
        System.out.println("Enter the name of the store or \"None\" if unknown:");
    ...
    public static double getTotal() {
        ...
        while(moreItems)
        {
            ...
            if(response != 'y' && response != 'Y') moreItems = false;
            in.nextLine();
        }
        return total;
    }
    ...
    public static void print(double total, String storeName) {
        System.out.printf("The total for your groceries items is: $%5.2f, "
